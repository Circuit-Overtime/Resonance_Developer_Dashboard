...
const toggleReg = () => {
  ...
  function toogle_visibility_login()
  {
    ...
    if(toogleViewtxt.type === 'password')
    {
      ...
      document.getElementById("passwd_toogle_login").setAttribute('class', 'fa-eye fa-eye-slash');
    }
    else
    {
  ...
  function toogle_visibility_reg()
  {
    ...
    if(toogleViewtxt_reg.type === 'password')
    {
      ...
      document.getElementById("passwd_toogle_register").setAttribute('class', 'fa-eye fa-eye-slash');
